...
- התחברות דמה (תמיד מצליחה)
- עו״ש — יתרה + תנועות דמה + באנר הלוואה
- כרטיסים — חיוב ואשראי, בחירה, הצגת פרטים מלאים עם טיימר
- פרופיל — פרטים, העדפות, יציאה
- דף הלוואה (דמו)
- מצב בהיר / כהה
- באנר דמו + הצהרת נגישות / פרטיות / תנאי שימוש
- צ׳אט AI («הבנקאי של …») — כרגע עם תשובות דמה; מוכן לחיבור Gemini דרך Worker
...
- נתונים מ־mock בקוד (+ העדפות ב־`sessionStorage`)
